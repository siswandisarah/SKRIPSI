...
<head>
  ...
  <title>Informasi Proses panen dan penanaman</title>
        ...
        <div class="row">
          ...
          $no= 1;
           ...
           foreach ($proses as $prs): ?>
            ...
            <td>          
                  <td><?php echo $prs['id']; ?></td>
                  <td><?php echo $prs['nama']; ?></td>
                  <td><?php echo $prs['nama_petani']; ?></td>
                  <td><?php echo $prs['alamat']; ?></td>  
                  <td><?php echo $prs['deskription']; ?></td>                     
                  <td><td>  <img src="<?php echo base_url() ?>/assets/foto/<?php echo $prs['foto']; ?>"  width ="100" height="100">
