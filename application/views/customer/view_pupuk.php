          ...
          <div class="col-lg-15">
            ...
            <div class="card">
              <div class="card-header border-5">
                <h3 class="card-title">Informasi Pupuk</h3>
          ...
          $no= 1;
           ...
           foreach ($pupuk as $ppk): ?>
            ...
            <td>          
                  ...
                  <td><td>  <img src="<?php echo base_url() ?>/assets/foto_pupuk/<?php echo $ppk['foto']; ?>"  width ="100" height="100">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Pupuk yang sering di gunakan</h3>
                <?php      
                    foreach ($query->result() as $row):?>
                <ul class="list-group list-group-unbordered mb-3">                 
                  <li class="list-group-item">
                    <b><?php echo $row->nama_pupuk;?></b> <a class="float-right"><?php echo $row->total;?></a>
                  </li>                 
                </ul>
                <?php endforeach; ?>
              </div>
